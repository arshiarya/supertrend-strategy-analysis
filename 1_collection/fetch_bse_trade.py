...
SYMBOL_COL = "bse_symbol"
START_DATE = "2001-01-01"
END_DATE   = date.today().isoformat()
OUT_DIR    = "C:\\Users\\mayan\\OneDrive\\Desktop\\stock_market_analysis\\bse_history_csv"
# ------------------------
    ...
    try:
        with conn.cursor() as cur:
            cur.execute(
                ...
                f"FROM {TABLE_FQN} "
                f"WHERE {SYMBOL_COL} IS NOT NULL AND {SYMBOL_COL} <> '' AND nse_symbol IS NULL"
            )
