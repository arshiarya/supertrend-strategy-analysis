...
# ---- CONFIG ----
FOLDER = "C:\\Users\\mayan\\OneDrive\\Desktop\\stock_market_analysis\\data\\bse_block_deals"
TABLE  = "stock_market_analysis.bse_block_deals"
PG_HOST = "localhost"
PG_PORT = 5432
PG_DB   = "postgres"
PG_USER = "postgres"
...
conn.close()
print(f"\nBSE Block Deals total loaded: {total} rows!")